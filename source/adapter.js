...
var adapter = {
	...
	init : function (fkey, roomId) {
		...
		this.roomid  = roomId || Number( /\d+/.exec(location)[0] );
		this.site    = 'stackoverflow'; //this.getCurrentSite(); FIXME
		this.user_id = 3422513; //CHAT.user.current().id;

		/* FIXME is this needed for Node?
		this.in.init();
		this.out.init();*/
	},
